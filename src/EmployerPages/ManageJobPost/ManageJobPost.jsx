      ...
      <div className="card bg-base-100 image-full shadow-xl">
        ...
        <div className=" py-10 px-4 card-body  justify-center items-center flex flex-col gap-6">
          ...
          <div className="card-actions">
            <button className="btn btn-primary" onClick={()=>navigate('/dashboard/postNewJob')}>Post Job</button>
          </div>
        </div>
      </div>
      <div className="card bg-base-100 image-full shadow-xl">
        ...
        <div className=" py-10 px-4 card-body  justify-center items-center flex flex-col gap-6">
          <h2 className="card-title text-4xl font-bold">View Previously Added Jobs</h2>
          <p>See the jobs you have added...</p>
          <div className="card-actions">
            <button className="btn btn-primary" onClick={()=>navigate('/dashboard/pastJobs')}>Post Job</button>
          </div>
        </div>
      </div>
